...
<body>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body question">
            <div class="container">
              <div class="row q1 qs active">
                <h3>Do you have Fever above 101.4?</h3>
                <img src="img/1.png" class="img-fluid question-image" />
                <div class="bottom">
                  <button
                    type="button"
                    onClick="recordAnswers(1,1,2)"
                    class="btn btn-primary btn-lg btn-block"
                  >
                    Yes, I do
                  </button>
              ...
              <div class="row q2 qs">
                ...
                <img src="img/2.png" class="img-fluid question-image" />
                <div class="bottom">
                  <button
                    type="button"
                    onClick="recordAnswers(2,1,3)"
                    class="btn btn-primary btn-lg btn-block"
                  >
                    Yes, I do
                  </button>
              ...
              <div class="row q3 qs">
                ...
                <img src="img/3.png" class="img-fluid question-image" />
                <div class="bottom">
                  <button
                    type="button"
                    onClick="recordAnswers(3,1,4)"
                    class="btn btn-primary btn-lg btn-block"
                  >
                    Yes, I do
                  </button>
              ...
              <div class="row q4 qs">
                ...
                <img src="img/4.png" class="img-fluid question-image" />
                <div class="bottom">
                  <button
                    type="button"
                    onClick="recordAnswers(4,1,5)"
                    class="btn btn-primary btn-lg btn-block"
                  >
                    Yes, I do
                  </button>
              ...
              <div class="row q5 qs">
                ...
                <img src="img/5.png" class="img-fluid question-image" />
                <div class="bottom">
                  <button
                    type="button"
                    onClick="recordAnswers(5,1,6)"
                    class="btn btn-primary btn-lg btn-block"
                  >
                    Yes, I do
                  </button>
              ...
              <div class="row q6 qs">
                ...
                <img src="img/6.png" class="img-fluid question-image" />
                <div class="bottom">
                  <button
                    type="button"
                    onClick="recordAnswers(6,1,7)"
                    class="btn btn-primary btn-lg btn-block"
                  >
                    Yes, I do
                  </button>
              ...
              <div class="row q7 qs">
                <h3>
                  Have you been in contact with any person who has recently
                  travelled internationally?
                </h3>
                <img src="img/7.png" class="img-fluid question-image" />
                <div class="bottom">
                  <button
                    type="button"
                    onClick="recordAnswers(7,1,8)"
                    class="btn btn-primary btn-lg btn-block"
                  >
                    Yes, I do
                  </button>
              ...
              <div class="row q8 qs">
                ...
                <img src="img/8.png" class="img-fluid question-image" />
                <div class="bottom">
                  <button
                    type="button"
                    onClick="recordAnswers(8,1,9)"
                    class="btn btn-primary btn-lg btn-block"
                  >
                    Yes, I do have
                  </button>
              ...
              <div class="row q9 qs">
                ...
                <img src="img/9.png" class="img-fluid question-image" />
                <div class="bottom">
                  <button
                    type="button"
                    onClick="recordAnswers(9,1,10)"
                    class="btn btn-primary btn-lg btn-block"
                  >
                    Yes, I am above 60
                  </button>
              ...
              <div class="row q10 qs">
                <h3>Due to Co-morbidities, do you take any medicine?</h3>
                <img src="img/10.png" class="img-fluid question-image" />
                <div class="bottom">
                  <button
                    type="button"
                    onClick="recordAnswers(10,1,0)"
                    class="btn btn-primary btn-lg btn-block"
                  >
                    Yes, I do
                  </button>
              ...
              <div class="row q11 qs">
                ...
                <p>
                  As of now, your answers suggest that you may need testing. If
                  anything changes, take the questionnaire again.
                </p>
              </div>
              <div class="row q12 qs">
              ...
              <div class="row q13 qs">
                <h3>You are all Good!</h3>
                <ol>
                  <li>No Test Needed At This Time</li>
                  <li>Maintain Social Distance</li>
                  <li>
                    Avoid groups of people and keep six feet apart from anyone
                    who’s not part of the household. Especially avoid those
                    showing symptoms.
                  </li>
                </ol>
                <p>
                  As of now, their answers suggest they do not need to get
                  tested. If anything changes, take the questionnaire again.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="container">
              <div class="row">
                ...
                <a
                  ...
                  aria-label="Learn more on who.int: Overview"
    ...
    <script>
      var question = 1;
      var answers = [];
      function recordAnswers(qno, ans, next) {
        answers[qno] = ans;
        jQuery(".qs").hide();
        jQuery(".q" + next).show();
        if (next == 0) {
          ...
          if ((q1, q2, q4, q8, q9, q6 === 1) && (q3, q5, q7, q10 === 1 || 2)) {
            ...
            (q1,
            q2,
            q4 === 1 && (q3, q6, q5, q7, q10 === 1 || 2) && (q8, q9 === 1 || 2))
          ) {
            jQuery(".qs").hide();
            jQuery(".q12").show();
          } else {
